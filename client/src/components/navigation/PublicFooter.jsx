    ...
    <footer className="border-t border-white/8 bg-[#050812] text-white">
      <div className="mx-auto max-w-[1500px] px-5 py-12 sm:px-8 lg:px-10 lg:py-16">
        <div className="grid gap-10 lg:grid-cols-[1.25fr_.75fr_.75fr_.9fr]">
          ...
          <div><p className="text-sm font-black">Need help?</p><p className="mt-4 text-sm leading-6 text-white/40">Track applications, viewings, messages and agreements from one clear workspace.</p><Link to="/help" className="mt-4 inline-flex items-center gap-1 text-sm font-black text-cyan-200">Help centre <ArrowUpRight className="h-3.5 w-3.5" /></Link><div className="mt-6 flex gap-2"><span className="grid h-9 w-9 place-items-center rounded-full border border-white/8 bg-white/[0.04] text-white/45"><Instagram className="h-4 w-4" /></span><span className="grid h-9 w-9 place-items-center rounded-full border border-white/8 bg-white/[0.04] text-white/45"><Linkedin className="h-4 w-4" /></span></div></div>
        </div>

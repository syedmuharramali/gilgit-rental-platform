    ...
    <div className="relative h-full w-full overflow-hidden rounded-[34px] bg-[#090d18] [perspective:1400px]">
      ...
      <GlassBadge className="left-5 top-5 sm:left-7 sm:top-7" delay={0.15}>
        <div className="flex items-center gap-3">
          ...
          <div><p className="text-[10px] font-bold uppercase tracking-[.16em] text-white/45">{t('hero.listingTrust')}</p><p className="mt-0.5 text-xs font-black">{t('hero.verifiedOwner')}</p></div>
        </div>
      </GlassBadge>
